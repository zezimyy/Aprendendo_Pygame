...
#reiniciar o jogo
def reiniciar_jogo():
    global ponto, comprimento_inicial, x_player, y_player, lista_corpo, lista_cabeca, x_moeda, y_moeda, morreu
    ponto = 0
    comprimento_inicial = 5
    x_player = largura/2 - 10
    y_player = altura/2 - 10
    lista_cabeca = []
    lista_corpo = []
    x_moeda = random.randint(16, 384)
    y_moeda = random.randint(16, 284)
...
while True:
    ...
    if lista_corpo.count(lista_cabeca) > 1:
        ...
        mensagem2 = "Game Over! Aperte R para reiniciar"
        mensagem_formatada = fonte2.render(mensagem2, True, (255,255,255))
        retangulo_texto = mensagem_formatada.get_rect()
        morreu = True
        ...
        while morreu:
            ...
            tela.blit(mensagem_formatada, (retangulo_texto))
